...
public:
    ...
    void setupUi(QWidget *courseBrowserWidget)
    {
        ...
        Namelabel = new QLabel(courseBrowserWidget);
        Namelabel->setObjectName("Namelabel");
        Namelabel->setGeometry(QRect(290, 30, 51, 21));
        Timelabel = new QLabel(courseBrowserWidget);
        Timelabel->setObjectName("Timelabel");
        Timelabel->setGeometry(QRect(260, 60, 131, 21));
    ...
    void retranslateUi(QWidget *courseBrowserWidget)
    {
        ...
        Namelabel->setText(QCoreApplication::translate("courseBrowserWidget", "\350\257\276\347\250\213\346\227\266\351\227\264", nullptr));
        Timelabel->setText(QCoreApplication::translate("courseBrowserWidget", "TextLabel", nullptr));
    } // retranslateUi
